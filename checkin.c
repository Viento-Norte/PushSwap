...
//si argc es >  a la matriz str ---> SEGmentation fault.
...
//Buscador cadenas duplicadas en la matriz argv.
//retorna 1 si hay cadenas duplicadas, caso contrario retorna 0
...
//si esta en rango retorna 1, caso contratrio 0 
...
{
	if (!ft_isnumbers(argc, argv) || ft_havedupli(argc, argv)
		|| !ft_isnuminrange(argc, argv))
		return (1);
	return (0);
}
/*////////Program check ft_checkerr//////////////////
